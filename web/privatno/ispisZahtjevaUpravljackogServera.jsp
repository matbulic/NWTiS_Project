...
<html>
    ...
    <body>
        ...
        <div class="sadrzaj">
            <form action="${pageContext.servletContext.contextPath}/IspisZahtjevaUpravljackogServera" method="post">
                ...
                Filtriraj po komandama:
                <select id="filterKomandi" name="filterKomandi" >
                    <option value=""></option>
                ...
                Filtriraj po datumu, od: <input type="text" name="datumOd5" value="" />
                do: <input type="text" name="datumDo5" value="" />
            ...
            <sql:transaction dataSource="${baza}">
                <sql:query var="ispis1">
                    ${sessionScope.upitServera}
                </sql:query>
            </sql:transaction>

            <display:table name="${ispis1.rows}" pagesize="${sessionScope.paginationValue}" sort="list" defaultsort="3" defaultorder="descending">
